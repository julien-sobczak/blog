...
To conclude, developing knowledge is easy but developing skills is hard. It requires perseverance, commitment, concentration, and almost all, time. If you spend most of your time acquiring new knowledge, you may be not doing the right thing. At this end, it is always the skills that make the difference because knowledge is the easier part of the competency equation.
