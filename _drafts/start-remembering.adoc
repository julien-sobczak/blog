...
*Remembering becomes easier when acknowledging how the memory works*. Nobody is good at rote memorization. With good associations, a endless curiosity, and an assiduity to test prior knowledge every day, remembering become accessible to everyone. It's only the first step. *Once you know how to remember, the next step is to determine what to remember*, a task far more difficult than it seems.
