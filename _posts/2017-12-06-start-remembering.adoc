...
- *I choose books more deliberately*. I favor books that help me to focus on the Big Picture (i.e. link:{% post_url 2015-03-19-building-microservices %}[_Building Microservices_] before delving into a particular implementation.)
